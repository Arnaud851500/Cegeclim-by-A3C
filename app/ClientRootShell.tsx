...
function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // connexion, quelle que soit la default_landing_page configurée pour le
  // profil (souvent une page desktop comme /tableaux-de-bord/vision-tci, qui
  // sur mobile bascule directement sur "Mon activité" — pas le menu voulu).
  const mobileLandingRedirectedRef = useRef(false)
  ...
  return (
    ...
    >
      ...
      <div style={styles.overlay}>
        {isMobile ? (
          <MobileBrandBar onLogout={handleLogout} />
        ) : (
          <header
...
// Tout le reste de l'app (auth, menu, alertes...) est ici plutôt que dans
// app/layout.tsx car il dépend de hooks client (usePathname, useState...).
// app/layout.tsx reste un composant SERVEUR (obligatoire pour pouvoir y
// exporter `metadata`/`viewport`) et se contente de poser <html>/<body> +
// les polices, puis délègue tout le reste ici.
