  ...
  function AppShell({ children }: { children: React.ReactNode }) {
    ...
    const menuGroups: MenuGroup[] = [
      ...
      },
      {
        ...
        items: [
          {label: '1 : OnePage TCI',activeLabel: 'OnePage TCI',path: '/tableaux-de-bord/vision-tci',accessKey: 'can_dashboard',},
          ...
          { label: '3 : Tableaux de bord', path: '/atelier-analyse', accessKey: 'can_dashboard' },
          ...
          { label: '8 : Analyse Devis', path: '/cycle-documents', accessKey: 'can_dashboard' },
