...
//
// ÉVOLUTION (2026-09-15 soir) : bloc « Prospects » (carte, sortie de Mes
// clients), « Suivi multi clients » et « Vision client 360 » déplacés de Mon
// activité vers Mes clients, nouveau bloc « Mes rdv » (/agenda).
// ============================================================================
...
export const NAV_BLOCS: NavBloc[] = [
  ...
  },
  {
    id: 'clients',
    label: 'Mes clients',
    subtitle: 'Fiches, suivi multi clients, vision 360',
    icon: '👥',
  ...
  },
  {
    id: 'prospects',
    label: 'Prospects',
    subtitle: 'Carte des prospects et clients',
    icon: '📍',
    gradient: ['#B5651D', '#7A4212'],
    iconBg: 'rgba(255,255,255,0.18)',
    pages: [
  ...
  },
  {
    id: 'rdv',
    label: 'Mes rdv',
    subtitle: 'Agenda, comptes rendus, recherche documents',
    icon: '📅',
    gradient: ['#5B4BC4', '#3A2E8A'],
    iconBg: 'rgba(255,255,255,0.18)',
    pages: [
      { label: 'Agenda', path: '/agenda', accessKey: 'can_dashboard', description: 'Planning des rendez-vous et fonctions de la Vision ONE PAGE : comptes rendus, documents liés.' },
    ],
  },
  {
    id: 'territoire',
